...
export function ModelSelectCard() {
  ...
  const [model, setModel] = useState("mean");
    ...
    <div className="bg-surface-dark rounded-xl border border-border-dark overflow-hidden flex flex-col">
      ...
      <div className="p-6 flex flex-col gap-6 flex-1">
        ...
        <div className="grid grid-cols-2 gap-4">
          <button
            onClick={() => setModel("mean")}
            className={`p-4 rounded-lg border transition-all text-center ${
              model === "mean" ? "border-primary bg-primary/5" : "border-border-dark bg-[#0d1117] hover:border-text-muted"
            }`}
          >
          ...
          <button
            onClick={() => setModel("trend")}
            className={`p-4 rounded-lg border transition-all text-center ${
              model === "trend" ? "border-primary bg-primary/5" : "border-border-dark bg-[#0d1117] hover:border-text-muted"
            }`}
          >
